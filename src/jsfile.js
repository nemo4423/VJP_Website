...
function add(element) {
    ...
    if (loopkierrokset == 1) {
        ...
        else if (numero < 11) {document.getElementById("palsu").innerHTML="Puhelimen käyttösi ei vaikuta olevan haitallista sosiaalisissa tilanteissa, mutta ihmissuhteidesi laatu voisi parantua, jos kiinnittäisit asiaan enemmän huomiota. Voit myös keskustella asiasta ystäviesi kanssa."}
        else if (numero < 16) {document.getElementById("palsu").innerHTML="Olet oikeilla raiteilla, mutta voisit vielä kiinnittää käytökseesi hieman enemmän huomiota. Ihmissuhteidesi laatu paranee, kun tietoisesti keskityt sosiaalisiin tilanteisiin paremmin."}
        else if (numero < 21) {document.getElementById("palsu").innerHTML="Toiminnassasi on kehityksen varaa. Oletko huomannut, että sinulta menee joskus muiden asioista osa ohi, kun huomiosi kiinnittyy hetkeksi puhelimeen? Ensimmäinen askel muutokseen on ongelman huomaaminen. Lue vinkkimme tilanteen parantamiseen ja palaa kahden viikon päästä tekemään testi uudelleen!"}
